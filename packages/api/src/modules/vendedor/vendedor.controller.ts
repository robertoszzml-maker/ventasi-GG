...
export class VendedorController {
  ...
  @Post()
  @RequirePermissions(PERMISOS.VENDEDOR_CREAR)
  create(@Body() dto: CreateVendedorDto) {
    return this.service.create(dto);
  }

  @Get()
  @RequirePermissions(PERMISOS.VENDEDOR_VER)
  findAll(
  ...
  @Patch(':id')
  @RequirePermissions(PERMISOS.VENDEDOR_EDITAR)
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateVendedorDto) {
    return this.service.update(id, dto);
  }

  @Delete(':id')
  @RequirePermissions(PERMISOS.VENDEDOR_ELIMINAR)
