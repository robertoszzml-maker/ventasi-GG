...
import { useDeleteFamiliasMutation } from '@/hooks/familias';

const baseUrl = '/familias';

const DataTableRowActions = ({ data }: { data: Familia }) => {
  const { mutate } = useDeleteFamiliasMutation();
...
export const columns: ColumnDef<Familia>[] = [
  {
    accessorKey: 'id',
    header: 'ID',
    cell: ({ row }) => (
