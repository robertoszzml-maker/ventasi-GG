# Referencia Técnica - Formularios de Configuración

## 1. Permisos

### Backend

**Ubicación:** `packages/api/src/constants/permisos.ts`
...
**Ubicación:** `packages/front/src/constants/permisos.ts`
...
**Ubicación:** `packages/api/src/constants/config.ts`
...
**Ubicación:** `packages/front/src/constants/config.ts`
...
**⚠️ Regla crítica:** La clave en BD debe ser igual al nombre de la constante para mantener sincronización.

## 3. Formulario

### Ubicación

`packages/front/src/components/forms/config/[modulo]-form.tsx`
...
`packages/front/src/app/(admin)/config/[modulo]/page.tsx`
...
**Importante:** La página debe ser un Server Component sin lógica.
