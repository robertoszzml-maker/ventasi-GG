# Referencia Técnica: Agregar Sección al Menú

## Ubicación

**Backend:** `packages/api/src/constants/routes.ts`

El frontend consume automáticamente esta configuración desde el backend.

---

## Templates

### Sección con Subrutas
...
Los iconos provienen de **Lucide React**. Usar **PascalCase**.
